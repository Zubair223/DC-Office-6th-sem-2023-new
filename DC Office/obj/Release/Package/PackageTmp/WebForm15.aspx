<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm15.aspx.cs" Inherits="Official_DC_Office.WebForm15" %>
     ...
     <div class="container" style="padding:57px" >
         <div class="row">
             <div class="col-md-6 mx-auto"> 
                 ...
                 <div class="card">
                     <div class="card-body">
                         ...
                         <div class="row">
                             <div class="col">
                                 <asp:Label style="font-size:20px" ID="Label1" runat="server" Text="User_ID:"></asp:Label>
            ...
            <asp:Button ID="Button1" runat="server" class="btn btn-primary btn-block btn-lg" Text="Login" OnClick="Button1_Click1"/>
                                 ...
                                 <div class="form-group">
            <asp:Button ID="Button2" runat="server" class="btn btn-info btn-block btn-lg" Text="Forgot Password" />
                                    </div>
                             </div>
                         </div>
