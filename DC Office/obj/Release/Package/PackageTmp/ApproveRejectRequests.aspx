...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server" >
   ...
   <center style="margin-bottom:80px"> 
       ...
       <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AppointmentID" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" width="800px" style="text-align:center" Height="400px" OnRowCommand="GridView1_RowCommand" >
           <Columns >
