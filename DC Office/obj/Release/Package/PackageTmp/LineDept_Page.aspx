...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <center>
        <asp:Label style="font-size:24px" ID="Label6" runat="server" Text="Line Department Officer Login"></asp:Label>
        ...
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataKeyNames="AppointmentID" DataSourceID="SqlDataSource1" BackColor="White" BorderColor="#336666" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" Height="120px" Width="130px" style="text-align:center" OnRowCommand="GridView1_RowCommand">
            <Columns>
                ...
                <asp:BoundField DataField="Uploaded_FileName" HeaderText="Uploaded_FileName" SortExpression="Uploaded_FileName"></asp:BoundField>
     ...
     <asp:Label style="font-size:24px" ID="Label4" runat="server" Text="Due Date Passed"></asp:Label>   <asp:GridView ID="GridView2" runat="server" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="2px" CellPadding="3" CellSpacing="1" GridLines="None" style="text-align:center">
         ...
         <asp:Label style="font-size:24px" ID="Label3" runat="server" Text="Due Date within 5 days Grid"></asp:Label>
