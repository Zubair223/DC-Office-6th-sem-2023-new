     ...
     <div class="container"  style="margin-bottom:48px" >
         <div class="row">
            ...
            <asp:TextBox ID="TextBox5" CssClass="form-control" style="font-size:15px" placeholder="Enter handler's name here" runat="server" ></asp:TextBox>
                                        <asp:RequiredFieldValidator  style="color:red" ID="RequiredFieldValidator5" runat="server" ErrorMessage="Handler name field must not be empty!" ValidationGroup="my" ControlToValidate="TextBox5"></asp:RequiredFieldValidator>
                         ...
                         <asp:RequiredFieldValidator  style="color:red" ID="RequiredFieldValidator6" runat="server" ErrorMessage="Signature must be uploaded !" ValidationGroup="my" ControlToValidate="FileUpload1"></asp:RequiredFieldValidator>                       
                             </div>

                                 <div class="col-md-6">
                                     <h3> Logo:</h3>     <asp:FileUpload ID="FileUpload2" runat="server" />
                                <asp:RequiredFieldValidator  style="color:red" ID="RequiredFieldValidator7" runat="server" ErrorMessage="Logo must be uploaded !" ValidationGroup="my" ControlToValidate="FileUpload2"></asp:RequiredFieldValidator>                       
                             </div>
