...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox ID="TextBox1" CssClass="form-control" TextMode="MultiLine" Height="80" style="font-size:18px" placeholder="Enter reason here" runat="server" ></asp:TextBox><br />
