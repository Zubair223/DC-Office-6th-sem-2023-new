<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Admin_Login.aspx.cs" Inherits="Official_DC_Office.WebForm5" %>
     ...
     <div class="container" style="padding:57px" >
         <div class="row">
             <div class="col-md-6 mx-auto"> 
                 ...
                 <div class="card">
                     <div class="card-body">
                         ...
                         <div class="row">
                             <div class="col">
                                 <asp:Label style="font-size:24px" ID="Label1" runat="server" Text="Username:"></asp:Label>
            ...
            <asp:Button ID="Button2" runat="server" class="btn btn-info btn-block btn-lg" Text="Forgot Password"  OnClick="Button2_Click"/>
                 ...
                 <h4> <a href="default1.aspx"><< Back to home page</a></h4>
             </div>
         </div>
     </div>
