<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="admin_forgot.aspx.cs" Inherits="Official_DC_Office.WebForm4" %>
...
<%-- <asp:Label ID="Label1" runat="server" Text="Enter your username"></asp:Label>
     ...
     <div class="container" style="padding:115px">
         <div class="row" >
            ...
            <asp:TextBox ID="TextBox1" CssClass="form-control" placeholder="Enter email here" runat="server" style="font-size:larger;margin-top:4px"></asp:TextBox>
